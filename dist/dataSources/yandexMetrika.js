...
class YandexMetrikaApi extends apollo_datasource_rest_1.RESTDataSource {
    ...
    getYandexMetrics(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return Object.assign(Object.assign({}, response), { data: response.data.map(d => (Object.assign(Object.assign({}, d), { metrics: d.metrics.map(mArr => mArr.map((m) => parseInt(m))) }))), totals: response.totals.map(ts => ts.map((t) => parseInt(t))) });
            }
            catch (e) {
                throw new Error(e);
            }
    ...
    getCounterId(bitrixGroupId) {
        return __awaiter(this, void 0, void 0, function* () {
            let counterId;
            try {
                const yandexMetrika = yield yandexMetrika_1.YandexMetrika.findOne({
                    bitrixGroupId
                });
